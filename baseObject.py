...
class baseObject(object): #abstract class--> methods in this class, not going to create instance of this class
    ...
    def connect(self):
        import config
        self.conn = pymysql.connect(host=config.DB['host'], port=config.DB['port'], user='abcolli', passwd='Capecod3!', db='abcolli_is437', autocommit=True)
